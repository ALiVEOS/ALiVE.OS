...
switch(_operation) do {
    ...
    case "init": {
        ...
        if (hasInterface) then {
            ...
            private _blacklistAreas = [_logic, "blacklist", _logic getVariable ["blacklist", DEFAULT_BLACKLIST]] call MAINCLASS;
    ...
    case "placement": {
        ...
        if (isServer) then {
            ...
            [[_faction, _ambientVehicleFaction]] call ALiVE_fnc_initFindVehicleTypeCache;
