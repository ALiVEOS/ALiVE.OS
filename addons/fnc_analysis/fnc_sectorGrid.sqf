...
switch(_operation) do {
    ...
    case "createGrid": {
        ...
        _gridPosition params ["_gridPositionX","_gridPositionY"];

        _sectorDimensions params ["_sectorWidth","_sectorHeight"];
    ...
    case "gridIndexToSector": {
        ...
        _args params ["_rowIndex","_columnIndex"];
    ...
    case "surroundingSectors": {
        ...
        _gridIndex params ["_indexX","_indexY"];
    ...
    case "sectorsInRadius": {
        ...
        if(_radius > _sectorWidth) then {
            ...
            {
                private _centre = [_x, "center"] call ALIVE_fnc_sector;
