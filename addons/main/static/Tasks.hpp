...
// Generated Tasks
	...
	ALIVE_autoGeneratedTasks = ["MilAssault","MilDefence","CivAssault","Assassination","TransportInsertion","DestroyVehicles","DestroyInfantry","SabotageBuilding","InsurgencyPatrol","InsurgencyDestroyAssets","Rescue","CSAR","CAS","DestroyBuilding","OCA","Wiretap","AidDelivery","MeetLocalLeader","VIPEscort","RepairCriticalService"];
...
// Military Objective Defence Task
	...
	_taskData = [] call ALIVE_fnc_hashCreate;
	[_taskData,"title","Secure Community Event"] call ALIVE_fnc_hashSet;
	[_taskData,"description","Provide security for a high-profile gathering near %1."] call ALIVE_fnc_hashSet;
	[_tasksData,"Parent",_taskData] call ALIVE_fnc_hashSet;

	_taskData = [] call ALIVE_fnc_hashCreate;
	[_taskData,"title","Move to event location"] call ALIVE_fnc_hashSet;
	[_taskData,"description","Deploy to %1, coordinate security positions and prepare for hostile disruption."] call ALIVE_fnc_hashSet;
	[_taskData,"chat_start",[["HQ","Proceed to %1 and establish security for a major civilian event, Over"],["PLAYERS","Roger Out"]]] call ALIVE_fnc_hashSet;
	[_tasksData,"Travel",_taskData] call ALIVE_fnc_hashSet;

	_taskData = [] call ALIVE_fnc_hashCreate;
	[_taskData,"title","Protect the event"] call ALIVE_fnc_hashSet;
	[_taskData,"description","Defeat hostile forces threatening the event area and keep VIP attendees safe."] call ALIVE_fnc_hashSet;
	[_taskData,"chat_start",[["PLAYERS","Security elements in place at event location, Over"],["HQ","Maintain perimeter and protect attendees"]]] call ALIVE_fnc_hashSet;
	[_taskData,"chat_success",[["PLAYERS","Event area secure, threat neutralised, Over"],["HQ","Roger. Outstanding work, Out."]]] call ALIVE_fnc_hashSet;
	[_taskData,"chat_missile_strike",[["HQ","Warning, possible indirect fire on event area. Take cover and protect the VIPs, Over"],["PLAYERS","Roger, Out"]]] call ALIVE_fnc_hashSet;
	[_taskData,"reward",["forcePool",20]] call ALIVE_fnc_hashSet;
	[_tasksData,"DefenceWave",_taskData] call ALIVE_fnc_hashSet;
...
// Aid Delivery Task
	...
	_taskData = [] call ALIVE_fnc_hashCreate;
	[_taskData,"title","Escort Supply Convoy to %1"] call ALIVE_fnc_hashSet;
	[_taskData,"description","Move critical supplies to %1 and supervise distribution under armed escort."] call ALIVE_fnc_hashSet;
	[_tasksData,"Parent",_taskData] call ALIVE_fnc_hashSet;

	_taskData = [] call ALIVE_fnc_hashCreate;
	[_taskData,"title","Rally at convoy departure"] call ALIVE_fnc_hashSet;
	[_taskData,"description","Rally near %1, secure convoy elements and prepare for movement."] call ALIVE_fnc_hashSet;
	[_taskData,"chat_start",[["HQ","Rally near %1, secure the convoy and prepare to move, Over."],["PLAYERS","Roger, convoy security acknowledged."]]] call ALIVE_fnc_hashSet;
	[_tasksData,"Travel",_taskData] call ALIVE_fnc_hashSet;

	_taskData = [] call ALIVE_fnc_hashCreate;
	[_taskData,"title","Deliver convoy supplies"] call ALIVE_fnc_hashSet;
	[_taskData,"description","Deliver the convoy load in %1 and remain on station until distribution is complete."] call ALIVE_fnc_hashSet;
	[_taskData,"chat_start",[["HQ","Convoy contact is waiting at %1. Deliver and secure the handover, Over."],["PLAYERS","Roger, moving convoy now."]]] call ALIVE_fnc_hashSet;
	[_taskData,"chat_success",[["PLAYERS","Convoy supplies delivered in %1, Over."],["HQ","Roger. Local support should improve, Out."]]] call ALIVE_fnc_hashSet;
	[_taskData,"chat_failed",[["HQ","Convoy delivery failed at %1. Abort and await tasking, Over."],["PLAYERS","Roger, breaking contact."]]] call ALIVE_fnc_hashSet;
