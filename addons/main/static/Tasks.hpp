...
// Generated Tasks
	...
	// Default registry -- only assign if a C2ISTAR module's customAutoGeneratedTasks
	// REPLACE has not already populated it. Static data loads via a lower-priority
	// module AFTER C2ISTAR applies the player's task selection, so an unconditional
	// assignment here clobbered that selection back to the full list -- the constant
	// regen then picked types the player never chose (e.g. OCA / RemoveIED). (#942)
	if (isNil "ALIVE_autoGeneratedTasks") then {
		ALIVE_autoGeneratedTasks = ["MilAssault","MilDefence","CivAssault","Assassination","TransportInsertion","DestroyVehicles","DestroyInfantry","SabotageBuilding","InsurgencyPatrol","InsurgencyDestroyAssets","Rescue","CSAR","CAS","DestroyBuilding","OCA","Wiretap","RemoveIED","AidDelivery","SupplyConvoy","MeetLocalLeader","VIPEscort","SecureCommunityEvent","RepairCriticalService","MedicalOutreach","CheckpointPartnership","InformantExfiltration","MarketReopening"];
	};
...
// IED Disposal (EOD) Task
	...
	_taskData = [] call ALIVE_fnc_hashCreate;
	[_taskData,"title","IED Disposal near %1"] call ALIVE_fnc_hashSet;
	[_taskData,"description","Dispose of the IED reported near %1."] call ALIVE_fnc_hashSet;
	[_tasksData,"Parent",_taskData] call ALIVE_fnc_hashSet;

	_taskData = [] call ALIVE_fnc_hashCreate;
	[_taskData,"title","Dispose of the IED"] call ALIVE_fnc_hashSet;
	[_taskData,"description","We've had a report of an IED placed near %1. Get an EOD-qualified operator to the device and disarm it, or destroy it from a safe distance."] call ALIVE_fnc_hashSet;
	[_taskData,"chat_start",[["HQ","Report of an IED near %1. Move an EOD operator in to disarm it, or destroy it from cover. Mind your spacing, Over."],["PLAYERS","Roger, moving to deal with it, Out"]]] call ALIVE_fnc_hashSet;
	[_taskData,"chat_success",[["PLAYERS","The device has been dealt with, area is clear, Over"],["HQ","Good work, send SITREP and standby for further tasking, Out."]]] call ALIVE_fnc_hashSet;
	[_taskData,"reward",["forcePool",10]] call ALIVE_fnc_hashSet;
	[_tasksData,"Dispose",_taskData] call ALIVE_fnc_hashSet;

	_options set [count _options,_tasksData];

	[ALIVE_generatedTasks, "RemoveIED", ["IED Disposal",_options]] call ALIVE_fnc_hashSet;
...
// Wiretap Task
	...
	_taskData = [] call ALIVE_fnc_hashCreate;
	[_taskData,"title","Intercept Communications near %1"] call ALIVE_fnc_hashSet;
	[_taskData,"description","Conduct wiretap on %2 near %1!"] call ALIVE_fnc_hashSet;
	[_tasksData,"Parent",_taskData] call ALIVE_fnc_hashSet;

	_taskData = [] call ALIVE_fnc_hashCreate;
	[_taskData,"title","Wiretap %1"] call ALIVE_fnc_hashSet;
	[_taskData,"description","We received intelligence about a strategically important communications facility near %1. Infiltrate the objective and place a wiretap on the %2! Use a wiretap device or toolkit in order setup the wiretap."] call ALIVE_fnc_hashSet;
	...
	[ALIVE_generatedTasks, "Wiretap", ["Wiretap Comms Post",_options]] call ALIVE_fnc_hashSet;
...
// Aid Delivery Task
	...
	[ALIVE_generatedTasks, "AidDelivery", ["Aid Delivery",_options]] call ALIVE_fnc_hashSet;
// Supply Convoy Task
	...
	_taskData = [] call ALIVE_fnc_hashCreate;
	[_taskData,"title","Escort Supply Convoy from %1 to %2"] call ALIVE_fnc_hashSet;
	[_taskData,"description","Move a loaded civilian convoy from %1 to %2 and ensure the handover is completed safely."] call ALIVE_fnc_hashSet;
	[_tasksData,"Parent",_taskData] call ALIVE_fnc_hashSet;

	_taskData = [] call ALIVE_fnc_hashCreate;
	[_taskData,"title","Rally convoy in %1"] call ALIVE_fnc_hashSet;
	[_taskData,"description","Move to %1, secure the convoy vehicles and prepare the column for departure."] call ALIVE_fnc_hashSet;
	[_taskData,"chat_start",[["HQ","Move to %1 and secure the convoy before departure, Over."],["PLAYERS","Roger, convoy rally underway."]]] call ALIVE_fnc_hashSet;
	[_taskData,"chat_failed",[["HQ","Convoy rally in %1 has failed. Abort and await tasking, Over."],["PLAYERS","Roger, convoy compromised."]]] call ALIVE_fnc_hashSet;
	[_tasksData,"Rally",_taskData] call ALIVE_fnc_hashSet;

	_taskData = [] call ALIVE_fnc_hashCreate;
	[_taskData,"title","Escort convoy to %1"] call ALIVE_fnc_hashSet;
	[_taskData,"description","Escort the supply convoy from %1 to %2 and keep the vehicles operational along the route."] call ALIVE_fnc_hashSet;
	[_taskData,"chat_start",[["HQ","Escort the convoy from %1 to %2. Keep the route secure and keep the supplies moving, Over."],["PLAYERS","Roger, convoy moving now."]]] call ALIVE_fnc_hashSet;
	[_taskData,"chat_failed",[["HQ","The convoy movement to %1 has failed. Break contact and report, Over."],["PLAYERS","Roger, convoy halted."]]] call ALIVE_fnc_hashSet;
	[_tasksData,"Move",_taskData] call ALIVE_fnc_hashSet;

	_taskData = [] call ALIVE_fnc_hashCreate;
	[_taskData,"title","Deliver supplies in %1"] call ALIVE_fnc_hashSet;
	[_taskData,"description","Secure the destination in %1 and supervise the convoy handover."] call ALIVE_fnc_hashSet;
	[_taskData,"chat_start",[["HQ","Destination contact is waiting in %1. Secure the site and complete the handover, Over."],["PLAYERS","Roger, preparing the unload."]]] call ALIVE_fnc_hashSet;
	[_taskData,"chat_success",[["PLAYERS","Supplies delivered in %1, Over."],["HQ","Roger. That should improve local support, Out."]]] call ALIVE_fnc_hashSet;
	[_taskData,"chat_failed",[["HQ","Supply handover in %1 failed. Abort and await further orders, Over."],["PLAYERS","Roger, withdrawing from the site."]]] call ALIVE_fnc_hashSet;
	[_taskData,"reward",["forcePool",8]] call ALIVE_fnc_hashSet;
	[_tasksData,"Deliver",_taskData] call ALIVE_fnc_hashSet;

	_options set [count _options,_tasksData];

	[ALIVE_generatedTasks, "SupplyConvoy", ["Supply Convoy",_options]] call ALIVE_fnc_hashSet;

// Meet Local Leader Task
	...
	_taskData = [] call ALIVE_fnc_hashCreate;
	[_taskData,"title","Engage Leaders in %1"] call ALIVE_fnc_hashSet;
	[_taskData,"description","Meet the local leadership in %1 and address immediate concerns."] call ALIVE_fnc_hashSet;
	[_tasksData,"Parent",_taskData] call ALIVE_fnc_hashSet;

	_taskData = [] call ALIVE_fnc_hashCreate;
	[_taskData,"title","Hold Shura"] call ALIVE_fnc_hashSet;
	[_taskData,"description","Meet the local leader in %1 and conduct a face-to-face engagement."] call ALIVE_fnc_hashSet;
	[_taskData,"chat_start",[["HQ","The local leadership in %1 is willing to talk. Move in and hold a shura, Over."],["PLAYERS","Roger, moving to engage."]]] call ALIVE_fnc_hashSet;
	[_taskData,"chat_success",[["PLAYERS","We completed the shura in %1, Over."],["HQ","Roger. That should improve trust and future access in the area. Out."]]] call ALIVE_fnc_hashSet;
	[_taskData,"chat_failed",[["HQ","The leader engagement in %1 is no longer viable. Abort and await further orders, Over."],["PLAYERS","Roger, pulling back."]]] call ALIVE_fnc_hashSet;
	[_taskData,"reward",["forcePool",5]] call ALIVE_fnc_hashSet;
	[_tasksData,"Meet",_taskData] call ALIVE_fnc_hashSet;

	_options set [count _options,_tasksData];

	[ALIVE_generatedTasks, "MeetLocalLeader", ["Meet Local Leader",_options]] call ALIVE_fnc_hashSet;
...
// VIP Escort Task
	...
	_taskData = [] call ALIVE_fnc_hashCreate;
	[_taskData,"title","Escort VIP from %1 to %2"] call ALIVE_fnc_hashSet;
	[_taskData,"description","Secure a civilian VIP in %1, escort them to %2, then return them safely."] call ALIVE_fnc_hashSet;
	[_tasksData,"Parent",_taskData] call ALIVE_fnc_hashSet;

	_taskData = [] call ALIVE_fnc_hashCreate;
	[_taskData,"title","Secure VIP in %1"] call ALIVE_fnc_hashSet;
	[_taskData,"description","Move to %1, establish security and secure the VIP for movement."] call ALIVE_fnc_hashSet;
	[_taskData,"chat_start",[["HQ","Move to %1 and secure the VIP for escorted movement, Over."],["PLAYERS","Roger, moving to the VIP now."]]] call ALIVE_fnc_hashSet;
	[_taskData,"chat_failed",[["HQ","The VIP at %1 is no longer secure. Abort and await tasking, Over."],["PLAYERS","Roger, pulling back."]]] call ALIVE_fnc_hashSet;
	[_tasksData,"Pickup",_taskData] call ALIVE_fnc_hashSet;

	_taskData = [] call ALIVE_fnc_hashCreate;
	[_taskData,"title","Escort VIP to %1"] call ALIVE_fnc_hashSet;
	[_taskData,"description","Escort the VIP safely to %1 and maintain control under contact."] call ALIVE_fnc_hashSet;
	[_taskData,"chat_start",[["HQ","Escort the VIP to %1. Keep them moving and protected, Over."],["PLAYERS","Roger, escorting now."]]] call ALIVE_fnc_hashSet;
	[_taskData,"chat_failed",[["HQ","VIP escort to %1 has failed. Abort and report, Over."],["PLAYERS","Roger, escort compromised."]]] call ALIVE_fnc_hashSet;
	[_tasksData,"Escort",_taskData] call ALIVE_fnc_hashSet;

	_taskData = [] call ALIVE_fnc_hashCreate;
	[_taskData,"title","Return VIP to %1"] call ALIVE_fnc_hashSet;
	[_taskData,"description","Return the VIP to %1 and confirm a safe handover."] call ALIVE_fnc_hashSet;
	[_taskData,"chat_start",[["HQ","Good work. Return the VIP safely to %1 for final handover, Over."],["PLAYERS","Roger, returning VIP now."]]] call ALIVE_fnc_hashSet;
	[_taskData,"chat_success",[["PLAYERS","VIP returned safely to %1, Over."],["HQ","Roger. Excellent escort execution, Out."]]] call ALIVE_fnc_hashSet;
	[_taskData,"chat_failed",[["HQ","VIP return to %1 failed. Break contact and report, Over."],["PLAYERS","Roger, unable to complete handover."]]] call ALIVE_fnc_hashSet;
	[_taskData,"reward",["forcePool",12]] call ALIVE_fnc_hashSet;
	[_tasksData,"Return",_taskData] call ALIVE_fnc_hashSet;

	_options set [count _options,_tasksData];

	[ALIVE_generatedTasks, "VIPEscort", ["VIP Escort",_options]] call ALIVE_fnc_hashSet;
// Secure Community Event Task
	...
	_taskData = [] call ALIVE_fnc_hashCreate;
	[_taskData,"title","Secure Community Event in %1"] call ALIVE_fnc_hashSet;
	[_taskData,"description","Protect a public gathering in %1 and keep the attending VIPs alive."] call ALIVE_fnc_hashSet;
	[_tasksData,"Parent",_taskData] call ALIVE_fnc_hashSet;

	_taskData = [] call ALIVE_fnc_hashCreate;
	[_taskData,"title","Deploy to %1"] call ALIVE_fnc_hashSet;
	[_taskData,"description","Move to %1, establish security positions and prepare the event site for hostile disruption."] call ALIVE_fnc_hashSet;
	[_taskData,"chat_start",[["HQ","Move to %1 and establish security for the community event, Over."],["PLAYERS","Roger, moving to event site."]]] call ALIVE_fnc_hashSet;
	[_taskData,"chat_failed",[["HQ","The event in %1 is no longer secure. Abort and report, Over."],["PLAYERS","Roger, event compromised."]]] call ALIVE_fnc_hashSet;
	[_tasksData,"Setup",_taskData] call ALIVE_fnc_hashSet;

	_taskData = [] call ALIVE_fnc_hashCreate;
	[_taskData,"title","Protect event in %1"] call ALIVE_fnc_hashSet;
	[_taskData,"description","Hold the event site in %1, defeat hostile disruption, and keep the VIP attendees alive until the gathering concludes."] call ALIVE_fnc_hashSet;
	[_taskData,"chat_start",[["HQ","Attendees are on site in %1. Maintain the perimeter and protect the VIPs, Over."],["PLAYERS","Roger, security cordon established."]]] call ALIVE_fnc_hashSet;
	[_taskData,"chat_success",[["PLAYERS","Community event secured in %1, Over."],["HQ","Roger. Local confidence should improve, Out."]]] call ALIVE_fnc_hashSet;
	[_taskData,"chat_failed",[["HQ","The event in %1 has collapsed under hostile action. Break contact and report, Over."],["PLAYERS","Roger, event lost."]]] call ALIVE_fnc_hashSet;
	[_taskData,"reward",["forcePool",12]] call ALIVE_fnc_hashSet;
	[_tasksData,"Secure",_taskData] call ALIVE_fnc_hashSet;

	_options set [count _options,_tasksData];

	[ALIVE_generatedTasks, "SecureCommunityEvent", ["Secure Community Event",_options]] call ALIVE_fnc_hashSet;

// Repair Critical Service Task
	...
	_taskData = [] call ALIVE_fnc_hashCreate;
	[_taskData,"title","Restore Services in %1"] call ALIVE_fnc_hashSet;
	[_taskData,"description","Repair a damaged or degraded %2 near %1 to show sustained support to the local population."] call ALIVE_fnc_hashSet;
	[_tasksData,"Parent",_taskData] call ALIVE_fnc_hashSet;

	_taskData = [] call ALIVE_fnc_hashCreate;
	[_taskData,"title","Repair %1"] call ALIVE_fnc_hashSet;
	[_taskData,"description","Repair the %3 near %1. Use a toolkit at the %2 to restore service."] call ALIVE_fnc_hashSet;
	[_taskData,"chat_start",[["HQ","A key %2 near %1 needs immediate repair. Restore service and reassure the locals, Over."],["PLAYERS","Roger, moving to repair site."]]] call ALIVE_fnc_hashSet;
	[_taskData,"chat_success",[["PLAYERS","The service site in %1 is operational again, Over."],["HQ","Roger. That should generate good will with the local population. Out."]]] call ALIVE_fnc_hashSet;
	[_taskData,"chat_failed",[["HQ","The repair effort in %1 has failed. Abort and await new tasking, Over."],["PLAYERS","Roger, RTB."]]] call ALIVE_fnc_hashSet;
	[_taskData,"reward",["forcePool",8]] call ALIVE_fnc_hashSet;
	[_tasksData,"Repair",_taskData] call ALIVE_fnc_hashSet;

	_options set [count _options,_tasksData];

	[ALIVE_generatedTasks, "RepairCriticalService", ["Repair Critical Service",_options]] call ALIVE_fnc_hashSet;
// Medical Outreach Task
	...
	_taskData = [] call ALIVE_fnc_hashCreate;
	[_taskData,"title","Medical Outreach in %1"] call ALIVE_fnc_hashSet;
	[_taskData,"description","Establish a temporary clinic in %1 and reassure the local population with visible medical support."] call ALIVE_fnc_hashSet;
	[_tasksData,"Parent",_taskData] call ALIVE_fnc_hashSet;

	_taskData = [] call ALIVE_fnc_hashCreate;
	[_taskData,"title","Move to %1"] call ALIVE_fnc_hashSet;
	[_taskData,"description","Proceed to the clinic site near %1 and prepare to support the outreach team."] call ALIVE_fnc_hashSet;
	[_taskData,"chat_start",[["HQ","Move to %1 and secure the temporary clinic site, Over."],["PLAYERS","Roger Out"]]] call ALIVE_fnc_hashSet;
	[_tasksData,"Travel",_taskData] call ALIVE_fnc_hashSet;

	_taskData = [] call ALIVE_fnc_hashCreate;
	[_taskData,"title","Open Clinic"] call ALIVE_fnc_hashSet;
	[_taskData,"description","Establish the temporary clinic in %1 and remain on station while treatment operations begin."] call ALIVE_fnc_hashSet;
	[_taskData,"chat_start",[["HQ","The medical team is staged at %1. Establish the clinic and keep the treatment point secure, Over."],["PLAYERS","Roger, moving to the clinic site now."]]] call ALIVE_fnc_hashSet;
	[_taskData,"chat_success",[["PLAYERS","Medical outreach established in %1, Over."],["HQ","Roger. That should improve local services and trust, Out."]]] call ALIVE_fnc_hashSet;
	[_taskData,"chat_failed",[["HQ","Medical outreach in %1 failed. Abort and await further tasking, Over."],["PLAYERS","Roger, breaking contact."]]] call ALIVE_fnc_hashSet;
	[_taskData,"reward",["forcePool",8]] call ALIVE_fnc_hashSet;
	[_tasksData,"Deliver",_taskData] call ALIVE_fnc_hashSet;
...
// Informant Exfiltration Task
	...
	_taskData = [] call ALIVE_fnc_hashCreate;
	[_taskData,"title","Extract Informant from %1 to %2"] call ALIVE_fnc_hashSet;
	[_taskData,"description","Secure a cooperating informant in %1 and move them to a protected debrief site in %2."] call ALIVE_fnc_hashSet;
	[_tasksData,"Parent",_taskData] call ALIVE_fnc_hashSet;

	_taskData = [] call ALIVE_fnc_hashCreate;
	[_taskData,"title","Secure informant in %1"] call ALIVE_fnc_hashSet;
	[_taskData,"description","Move to %1, establish local security, and secure the informant for movement."] call ALIVE_fnc_hashSet;
	[_taskData,"chat_start",[["HQ","Move to %1 and secure the informant for extraction, Over."],["PLAYERS","Roger, moving to the informant now."]]] call ALIVE_fnc_hashSet;
	[_taskData,"chat_failed",[["HQ","The informant in %1 is no longer secure. Abort and await tasking, Over."],["PLAYERS","Roger, pulling back."]]] call ALIVE_fnc_hashSet;
	[_tasksData,"Pickup",_taskData] call ALIVE_fnc_hashSet;

	_taskData = [] call ALIVE_fnc_hashCreate;
	[_taskData,"title","Escort informant to %1"] call ALIVE_fnc_hashSet;
	[_taskData,"description","Escort the informant safely to %1 and keep them under control while moving."] call ALIVE_fnc_hashSet;
	[_taskData,"chat_start",[["HQ","Escort the informant to %1. Keep them moving and protected, Over."],["PLAYERS","Roger, escorting now."]]] call ALIVE_fnc_hashSet;
	[_taskData,"chat_failed",[["HQ","Informant movement to %1 failed. Abort and report, Over."],["PLAYERS","Roger, escort compromised."]]] call ALIVE_fnc_hashSet;
	[_tasksData,"Escort",_taskData] call ALIVE_fnc_hashSet;

	_taskData = [] call ALIVE_fnc_hashCreate;
	[_taskData,"title","Complete handover in %1"] call ALIVE_fnc_hashSet;
	[_taskData,"description","Complete the handover in %1 and confirm the informant is secured."] call ALIVE_fnc_hashSet;
	[_taskData,"chat_start",[["HQ","Good work. Move the informant to the safe site in %1 for final handover, Over."],["PLAYERS","Roger, moving to the handover point now."]]] call ALIVE_fnc_hashSet;
	[_taskData,"chat_success",[["PLAYERS","Informant handed over safely in %1, Over."],["HQ","Roger. That should strengthen local trust and future access, Out."]]] call ALIVE_fnc_hashSet;
	[_taskData,"chat_failed",[["HQ","Informant handover in %1 failed. Break contact and report, Over."],["PLAYERS","Roger, unable to complete the handover."]]] call ALIVE_fnc_hashSet;
	[_taskData,"reward",["forcePool",14]] call ALIVE_fnc_hashSet;
	[_tasksData,"Return",_taskData] call ALIVE_fnc_hashSet;

	_options set [count _options,_tasksData];

	[ALIVE_generatedTasks, "InformantExfiltration", ["Informant Exfiltration",_options]] call ALIVE_fnc_hashSet;

// Market Reopening Task
	...
	_taskData = [] call ALIVE_fnc_hashCreate;
	[_taskData,"title","Reopen Market in %1"] call ALIVE_fnc_hashSet;
	[_taskData,"description","Protect the reopening market in %1 and keep the local traders and organizers alive."] call ALIVE_fnc_hashSet;
	[_tasksData,"Parent",_taskData] call ALIVE_fnc_hashSet;

	_taskData = [] call ALIVE_fnc_hashCreate;
	[_taskData,"title","Deploy to %1"] call ALIVE_fnc_hashSet;
	[_taskData,"description","Move to %1, establish security positions, and prepare the market site for hostile disruption."] call ALIVE_fnc_hashSet;
	[_taskData,"chat_start",[["HQ","Move to %1 and secure the reopening market, Over."],["PLAYERS","Roger, moving to the market site."]]] call ALIVE_fnc_hashSet;
	[_taskData,"chat_failed",[["HQ","The market in %1 is no longer secure. Abort and report, Over."],["PLAYERS","Roger, market compromised."]]] call ALIVE_fnc_hashSet;
	[_tasksData,"Setup",_taskData] call ALIVE_fnc_hashSet;

	_taskData = [] call ALIVE_fnc_hashCreate;
	[_taskData,"title","Protect market in %1"] call ALIVE_fnc_hashSet;
	[_taskData,"description","Hold the market site in %1, defeat hostile disruption, and keep traders and organizers alive while commerce resumes."] call ALIVE_fnc_hashSet;
	[_taskData,"chat_start",[["HQ","The market is opening in %1. Maintain the perimeter and keep traders and organizers safe, Over."],["PLAYERS","Roger, market security is established."]]] call ALIVE_fnc_hashSet;
	[_taskData,"chat_success",[["PLAYERS","Market reopening secured in %1, Over."],["HQ","Roger. That should improve local services and confidence, Out."]]] call ALIVE_fnc_hashSet;
	[_taskData,"chat_failed",[["HQ","The market in %1 collapsed under hostile action. Break contact and report, Over."],["PLAYERS","Roger, market lost."]]] call ALIVE_fnc_hashSet;
	[_taskData,"reward",["forcePool",12]] call ALIVE_fnc_hashSet;
	[_tasksData,"Secure",_taskData] call ALIVE_fnc_hashSet;
