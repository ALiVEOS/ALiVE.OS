...
// Generated Tasks
	...
	ALIVE_autoGeneratedTasks = ["MilAssault","MilDefence","CivAssault","Assassination","TransportInsertion","DestroyVehicles","DestroyInfantry","SabotageBuilding","InsurgencyPatrol","InsurgencyDestroyAssets","Rescue","CSAR","DCA","CAS","DestroyBuilding"];
...
// OCA Task
	...
	[_taskData,"description","We received intelligence about a strategically important airfield near %1! Deny the airfield by destroying critical infrastructure!"] call ALIVE_fnc_hashSet;
