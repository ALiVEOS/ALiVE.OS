...
Examples:
(begin example)
_obs = [_o, "observe", [_obj, _home, _lockHeld, _sortie, _now, _lockBusy, _playerGrace]] call ALIVE_fnc_ATOObserve;
...
switch(_operation) do {
    ...
    case "observe": {
        _args params [
            ...
            // The module's own wait before an aircraft a player got out of goes
