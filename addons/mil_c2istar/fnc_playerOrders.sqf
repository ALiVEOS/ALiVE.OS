...
switch (_operation) do {
    ...
    case "createGeneratedTaskForGroup": {
        ...
        private _taskType = [ALIVE_autoGeneratedTasks, _groupPos, "Short", _side, _faction, _tasksCurrent, _excludedTaskTypes] call ALiVE_fnc_taskSelectAutoGeneratedType;
    ...
    case "requestOrder": {
        ...
        if !(_created) then {
            _created = ["createGeneratedTaskForGroup", [_groupData, _enemyFaction, _excludedGeneratedTaskTypes]] call MAINCLASS;
        };
