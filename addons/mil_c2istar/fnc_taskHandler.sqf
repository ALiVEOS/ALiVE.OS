    ...
    case "autoGenerateTasks": {
        if (_args isEqualType []) then {
            ...
            if (!isNil "ALiVE_c2istar_taskDiag" && {ALiVE_c2istar_taskDiag}) then {
                ...
                ["[C2ISTAR #942 DIAG] autoGenerateTasks side=%1 pool=%2 countActive=%3 players=%4", _taskSide, _diagPool, _countActive, count (allPlayers - entities "HeadlessClient_F")] call ALIVE_fnc_dump;
            };
