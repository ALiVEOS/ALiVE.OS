...
[_this] spawn {
    ...
    if (count _classesForType == 0) exitWith {
        ["C2ISTAR - Task ExtractionForUnits - No %1 vehicle classes available for faction %2; aborting extraction spawn", _insertionType, _taskFaction] call ALiVE_fnc_Dump;
    };
