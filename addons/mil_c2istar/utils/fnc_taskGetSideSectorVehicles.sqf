...
SCRIPT(taskGetSideSectorVehicles);

/* ----------------------------------------------------------------------------
Function: ALIVE_fnc_taskGetSideSectorVehicles
...
_sideSectors = [ALIVE_battlefieldAnalysis,"getSectorsContainingSideVehicles",[_side]] call ALIVE_fnc_battlefieldAnalysis;
