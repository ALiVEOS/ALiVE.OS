...
_nodes = [];
_nodes pushback ["26773",[5852.29,4181.67,-0.00930405]];
...
_cluster = [nil, "create"] call ALIVE_fnc_cluster;
_nodes = [];
_nodes pushback ["268889",[1229.61,4781.84,-0.0732894]];
_nodes pushback ["268888",[1228.26,4805.13,0.178992]];
[_cluster,"nodes",_nodes] call ALIVE_fnc_hashSet;
[_cluster, "state", _cluster] call ALIVE_fnc_cluster;
...
_cluster = [nil, "create"] call ALIVE_fnc_cluster;
_nodes = [];
_nodes pushback ["193893",[3106.69,4626.68,0.020318]];
[_cluster,"nodes",_nodes] call ALIVE_fnc_hashSet;
[_cluster, "state", _cluster] call ALIVE_fnc_cluster;
...
_cluster = [nil, "create"] call ALIVE_fnc_cluster;
_nodes = [];
_nodes pushback ["282095",[1126.28,6654.55,0]];
_nodes pushback ["282096",[1129.81,6673.81,0.000968933]];
[_cluster,"nodes",_nodes] call ALIVE_fnc_hashSet;
[_cluster, "state", _cluster] call ALIVE_fnc_cluster;
...
_cluster = [nil, "create"] call ALIVE_fnc_cluster;
_nodes = [];
_nodes pushback ["41427",[3132.11,8717.26,-0.00769234]];
[_cluster,"nodes",_nodes] call ALIVE_fnc_hashSet;
[_cluster, "state", _cluster] call ALIVE_fnc_cluster;
...
_cluster = [nil, "create"] call ALIVE_fnc_cluster;
_nodes = [];
_nodes pushback ["125688",[9984.93,8948,-0.0164471]];
_nodes pushback ["125687",[9983.75,8968.79,0.000752449]];
_nodes pushback ["125686",[9983.3,8989.86,0.0324945]];
[_cluster,"nodes",_nodes] call ALIVE_fnc_hashSet;
[_cluster, "state", _cluster] call ALIVE_fnc_cluster;
...
_cluster = [nil, "create"] call ALIVE_fnc_cluster;
_nodes = [];
_nodes pushback ["227302",[9431.6,9838.79,-0.00807285]];
_nodes pushback ["228464",[9456.69,9838.61,0.00115681]];
[_cluster,"nodes",_nodes] call ALIVE_fnc_hashSet;
[_cluster, "state", _cluster] call ALIVE_fnc_cluster;
...
_cluster = [nil, "create"] call ALIVE_fnc_cluster;
_nodes = [];
_nodes pushback ["283029",[2291.91,7453.71,-0.00185204]];
[_cluster,"nodes",_nodes] call ALIVE_fnc_hashSet;
[_cluster, "state", _cluster] call ALIVE_fnc_cluster;
...
_cluster = [nil, "create"] call ALIVE_fnc_cluster;
_nodes = [];
_nodes pushback ["81675",[4678.16,7920.97,-0.00294495]];
[_cluster,"nodes",_nodes] call ALIVE_fnc_hashSet;
[_cluster, "state", _cluster] call ALIVE_fnc_cluster;
...
_cluster = [nil, "create"] call ALIVE_fnc_cluster;
_nodes = [];
_nodes pushback ["94690",[3228.85,8027.07,0.00176334]];
[_cluster,"nodes",_nodes] call ALIVE_fnc_hashSet;
[_cluster, "state", _cluster] call ALIVE_fnc_cluster;
...
_cluster = [nil, "create"] call ALIVE_fnc_cluster;
_nodes = [];
_nodes pushback ["125397",[9943.83,9477.5,0.0999999]];
_nodes pushback ["125390",[9922.43,9481.26,0.018857]];
_nodes pushback ["125389",[9953.65,9501.3,0.018857]];
_nodes pushback ["125388",[9994.68,9488.27,0.018857]];
_nodes pushback ["125398",[10014.3,9479.77,0.0999999]];
_nodes pushback ["125385",[10027.8,9504.95,0.018857]];
_nodes pushback ["125396",[9992.66,9543.03,0.0999999]];
_nodes pushback ["125392",[9977.83,9559.26,0.018857]];
_nodes pushback ["125391",[10015.2,9557.96,0.018857]];
_nodes pushback ["125393",[9948.14,9590.85,0.018857]];
_nodes pushback ["125395",[9926.33,9573.41,0.0999999]];
_nodes pushback ["125394",[9911.07,9588.32,0.018857]];
[_cluster,"nodes",_nodes] call ALIVE_fnc_hashSet;
[_cluster, "state", _cluster] call ALIVE_fnc_cluster;
...
_cluster = [nil, "create"] call ALIVE_fnc_cluster;
_nodes = [];
_nodes pushback ["269072",[5163.3,3918.37,-0.00744629]];
[_cluster,"nodes",_nodes] call ALIVE_fnc_hashSet;
[_cluster, "state", _cluster] call ALIVE_fnc_cluster;
...
_cluster = [nil, "create"] call ALIVE_fnc_cluster;
_nodes = [];
_nodes pushback ["94925",[3748.31,4415.09,-0.039567]];
[_cluster,"nodes",_nodes] call ALIVE_fnc_hashSet;
[_cluster, "state", _cluster] call ALIVE_fnc_cluster;
...
_cluster = [nil, "create"] call ALIVE_fnc_cluster;
_nodes = [];
_nodes pushback ["90936",[4551.6,5517.94,0.0105343]];
[_cluster,"nodes",_nodes] call ALIVE_fnc_hashSet;
[_cluster, "state", _cluster] call ALIVE_fnc_cluster;
...
_cluster = [nil, "create"] call ALIVE_fnc_cluster;
_nodes = [];
_nodes pushback ["92818",[3388.63,6523.28,0.00657272]];
[_cluster,"nodes",_nodes] call ALIVE_fnc_hashSet;
[_cluster, "state", _cluster] call ALIVE_fnc_cluster;
