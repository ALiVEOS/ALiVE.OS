...
//Starting Init
["| Khe Sanh Valley - Executing init.sqf..."] call ALiVE_fnc_dump;
...
if (hasInterface) then {
    ...
    ["| Khe Sanh Valley - Running ClientInit..."] call ALiVE_fnc_dump;
    ...
    [] spawn {
     //   enableRadio false;
        ...
        _title = "<t size='1.5' color='#68a7b7' shadow='1'>KHE SANH VALLEY</t><br/>";
