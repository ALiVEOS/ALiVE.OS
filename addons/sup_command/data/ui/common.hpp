...
class SCOMTablet_RscListNBoxArrowRight: SCOMTablet_RscButton
{
    idc = 1000;
    text = "<";
    borderSize = 0;
...
class SCOMTablet_RscListNBoxArrowLeft: SCOMTablet_RscListNBoxArrowRight
{
    idc = 1001;
    text = ">";
};

class SCOMTablet_RscListNBox {
...
class SCOMTablet_RscGUIListBox : SCOMTablet_RscListBox {
    color[] = {1, 1, 1, 1};
