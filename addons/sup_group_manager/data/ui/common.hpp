...
// #698 schematic (drawn-map) variant for the terrain-mode toggle - identical to GMTablet_RscMap but
// with the satellite layer off. ALIVE_fnc_mapControlSwap swaps the map between these two.
class GMTablet_RscMapSchematic : GMTablet_RscMap
{
    maxSatelliteAlpha = 0;
};
