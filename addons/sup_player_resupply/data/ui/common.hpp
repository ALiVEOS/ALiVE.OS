...
// #698 schematic (drawn-map) variant for the terrain-mode toggle - identical to PRTablet_RscMap but
// with the satellite layer off. ALIVE_fnc_mapControlSwap swaps the map between these two.
class PRTablet_RscMapSchematic : PRTablet_RscMap
{
    maxSatelliteAlpha = 0;
};
