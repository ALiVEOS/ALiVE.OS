...
switch(_operation) do {
    ...
    case "create": {
        ...
        _args params ["_configName","_displayName","_side","_flag","_icon",["_shortName",""],["_camo",""]];
        ...
        _result = [
            [
                ...
                ["groupCategories", _groupsByCategory],
                ["assetCategories", []],
                ["assets", []],
                ["assetsImportedConfig", false]
            ]
    ...
    case "init": {
        ...
        [_logic,"shortName", ""] call ALiVE_fnc_hashSet;
