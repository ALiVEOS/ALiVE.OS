...
class patrolrep_RscText_Right : patrolrep_RscText
{
    idc = -1;
    class Attributes
    {
...
class patrolrep_RscGUIListBox : patrolrep_RscListBox {
    color[] = {1, 1, 1, 1};
