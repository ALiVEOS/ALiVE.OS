...
if(ALiVE_SYS_DATA_DEBUG_ON) then {
    ["SAVE SYS PATROLREP DATA NOW - MISSION NAME: %1! PLEASE WAIT...",_missionName] call ALiVE_fnc_dump;
...
if(ALiVE_SYS_DATA_DEBUG_ON) then {
    ...
    ["SYS PATROLREP SAVE DATA RESULT: %1",_saveResult] call ALiVE_fnc_dump;
};
