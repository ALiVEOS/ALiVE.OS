...
class CfgVehicles
{
    ...
    class ADDON : ModuleAliveBase
    {
        ...
        class Attributes : AttributesBase
        {
            ...
            class playertags_restricttofriendly_setting: Combo
            {
                property = MVAR(playertags_restricttofriendly_setting);
                displayName = "$STR_ALIVE_PLAYERTAGS_FRIENDLYUNITSONLY";
                tooltip = "$STR_ALIVE_PLAYERTAGS_FRIENDLYUNITSONLY_COMMENT";
                defaultValue = """true""";
                class Values
                {
                    class Yes
