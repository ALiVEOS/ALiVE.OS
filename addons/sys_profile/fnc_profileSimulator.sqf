...
{
    [ALiVE_profiles_quadtree,"clear"] call ALiVE_fnc_quadtree;

    {
        [ALiVE_profiles_quadtree,"insert", [_x select 2 select 2, _x]] call ALiVE_fnc_quadtree;
        false
    } count (_profiles select 2);
} call CBA_fnc_directCall;
