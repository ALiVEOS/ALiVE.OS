...
[_profileVehicle1, "vehicleClass", "O_Heli_Attack_02_F"] call ALIVE_fnc_profileVehicle;
...
[_profileVehicle2, "position", ((getPos player) getPos [20, 180])] call ALIVE_fnc_profileVehicle;
