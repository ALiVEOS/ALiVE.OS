...
[_profileVehicle, "position", ((getPos player) getPos [20, 180])] call ALIVE_fnc_profileVehicle;
...
[_profileVehicle2, "position", ((getPos player) getPos [40, 180])] call ALIVE_fnc_profileVehicle;
