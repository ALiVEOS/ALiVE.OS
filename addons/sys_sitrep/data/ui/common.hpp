...
// #698 schematic (drawn-map) variant for the terrain-mode toggle - identical to SITREP_RscMap but
// with the satellite layer off. ALIVE_fnc_mapControlSwap swaps the map between these two.
class SITREP_RscMapSchematic : SITREP_RscMap
{
    maxSatelliteAlpha = 0;
};
