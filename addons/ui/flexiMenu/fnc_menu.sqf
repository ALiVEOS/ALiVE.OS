...
// Notes: alive_UI_fnc_setObjectMenuSource allows you to assign a menu source to a particular object. It will add an object variable called QUOTE(GVAR(flexiMenu_source)) containing the menu source.
//-----------------------------------------------------------------------------
// Syntax 1: _source
