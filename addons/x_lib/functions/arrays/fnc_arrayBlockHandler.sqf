...
TRACE_2("arrayBlockHandler - input: operation, argument type",_operation,typeName _args);
...
switch (_operation) do {
    ...
    case "getNextBlock": {
        ...
        TRACE_5("arrayBlockHandler getNextBlock: key, source count, requested limit, start pointer, returned count",_blockKey,count _sourceArray,_blockLimit,_currentPointer,count _block);
    };
    case "state": {
        private["_state"];
...
TRACE_2("arrayBlockHandler - output: operation, result type",_operation,typeName _result);
