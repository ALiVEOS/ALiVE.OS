...
#define MAP_TYPES_BUILDING          ["BUILDING","HOUSE","RUIN","BUNKER","BUSSTOP","CHAPEL","CHURCH","CROSS","FOUNTAIN","POWER LINES","FUELSTATION","HIDE","HOSPITAL","LIGHTHOUSE","TRANSMITTER","VIEW-TOWER","WATERTOWER","FORTRESS","POWERSOLAR","POWERWAVE","POWERWIND"]
#define MAP_TYPES_VEGETATION        ["TREE","SMALL TREE","BUSH","FOREST BORDER","FOREST SQUARE","FOREST TRIANGLE","FOREST"]
#define MAP_TYPES_WALL              ["FENCE","WALL"]
#define MAP_TYPES_MISC              ["ROCK","ROCKS","QUAY","RAILWAY","SHIPWRECK","STACK","TOURISM"]
