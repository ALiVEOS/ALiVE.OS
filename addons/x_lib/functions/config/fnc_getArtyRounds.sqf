...
private _class = if (_this isEqualTo "BUS_MotInf_MortTeam") then { "B_MBT_01_arty_F" } else { _this };
private _weapon = [configfile >> "CfgVehicles" >> _class >> "Turrets" >> "MainTurret" >> "weapons"] call ALiVE_fnc_getConfigValue;
