...
/*
    ...
    _furthestEnemy = [[_enemy1,_enemy2,_enemy3],[_friendly],{_input0 distance _x},"DESCEND",{canMove _x}] call ALiVE_fnc_SortBy;
*/
...
_inputArray = _inputArray apply { [_x call _algorithmFnc, _x] };
_inputArray sort (_sortDirection == "ASCEND");
_inputArray = _inputArray apply { _x select 1 };
