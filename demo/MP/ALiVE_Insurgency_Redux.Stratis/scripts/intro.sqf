...
if (hasInterface) then {
    ...
    [] spawn {
		...
		_title = "<t size='1.2' color='#e5b348' shadow='1' shadowColor='#000000'>INSURGENCY | ALiVE</t>
		<img color='#ffffff' image='media\images\img_line_ca.paa' align='left' size='0.60' /><br/>";
        _text = format["%1<t>Players must search houses or kill enemy infantry to find INTEL items to help discover enemy cache locations.</t>
        ...
        _title = "<t size='1.2' color='#e5b348' shadow='1' shadowColor='#000000'>INSURGENCY | ALiVE</t>
		<img color='#ffffff' image='media\images\img_line_ca.paa' align='left' size='0.60' /><br/>";
        _text = format["%1<t>Destroy %2 randomly generated cache locations to win! Dont forget to search and clear the indicated red grids. When a grid is cleared it will turn green.</t>
