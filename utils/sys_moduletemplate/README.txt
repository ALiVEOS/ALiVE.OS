...
A template module that follows the sys_logistics model
 - Auto-enabled
 - Additional, optional module to provide configuration (for overriding default values)
 - Additionally, only active if the ALiVE requires or ALiVE profiles modules are enabled
